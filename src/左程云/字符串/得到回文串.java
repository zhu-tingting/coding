...
/**
 * Created by zhutingting on 2017/9/18.
 */
public class 得到回文串 {
    ...
    //输入一个字符串，得到最短回文串,采用dp算法，时间复杂度O(N^2)
    ...
    //输入一个字符串和其包含的最大回文串，将字符串变为回文串，时间复杂度为O(N)
    ...
    public static void main(String[] args) {
        ...
        String str2="A1B21C";
        String strlps="121";
        System.out.println(getPalindrome2(str2,strlps));
    }
}
